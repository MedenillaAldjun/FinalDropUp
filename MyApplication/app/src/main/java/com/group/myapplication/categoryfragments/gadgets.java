...
import com.group.myapplication.Adapter.GadgetAdapter;
...
public class gadgets extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.gadgets_swipelayout);
        ...
        recyclerView = view.findViewById(R.id.gadgets_recview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mList = new ArrayList<>();
        adapter = new GadgetAdapter(getContext(), mList);
        ...
        if(firebaseAuth.getCurrentUser() != null){
            ...
            query = firestore.collection("Gadgets").orderBy("time", Query.Direction.DESCENDING);
