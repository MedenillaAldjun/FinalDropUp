...
public class BuyerNotificationsAdapter extends RecyclerView.Adapter<BuyerNotificationsAdapter.RequestViewHolder> {
    ...
    public BuyerNotificationsAdapter(Activity context,  List<BuyerNotifications> mList){
        this.mList = mList;
    ...
    @NonNull
    @Override
    public BuyerNotificationsAdapter.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.each_buyer_notif, parent, false);
        firestore = FirebaseFirestore.getInstance();
        return new BuyerNotificationsAdapter.RequestViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull BuyerNotificationsAdapter.RequestViewHolder holder, int position1) {
        BuyerNotifications notif = mList.get(position1);
...
// Get the "comments" subcollection of the post
        CollectionReference commentsRef = postRef.collection("BuyerNotif");
                ...
                alert.setTitle("Delete Notification?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                showPD();
                                CollectionReference commentsRef = firestore.collection("Users").document(userId).collection("BuyerNotif");
    ...
    public class RequestViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView postUsername,postDate,postCaption, mapAddress;
        View view;
        ImageButton delete;
        Button rates, searchMap, order;
        ...
        public RequestViewHolder(@NonNull View itemView) {
            ...
            order = view.findViewById(R.id.order_rec);
            delete = view.findViewById(R.id.buyernotif_delte);

            order.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent rate = new Intent(context, Ratings.class);
            ...
            searchMap.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Uri uri = Uri.parse("geo:0,0?q=" + mapAddress.getText().toString());
