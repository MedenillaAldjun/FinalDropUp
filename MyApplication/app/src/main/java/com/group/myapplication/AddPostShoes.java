...
public class AddPostShoes extends AppCompatActivity {
        ...
        publish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!product.isEmpty() && !price.isEmpty() && !address.isEmpty() && mImgUrl!= null){
                            ...
                            if(task.isSuccessful()){
                                postRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        firestore.collection("Shoes").add(postMap).addOnCompleteListener(new OnCompleteListener<DocumentReference>() {
                                            @Override
                                            public void onComplete(@NonNull Task<DocumentReference> task) {
                                                if(task.isSuccessful()){
                                                    ...
                                                    toast.show();
                                                    startActivity(new Intent(AddPostShoes.this, SellerDashboard.class));
                                                    finish();
                                                }else{
                                                    post_progressbar.setVisibility(View.INVISIBLE);
                                                    Toast.makeText(AddPostShoes.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                                    }
                                ...
                                post_progressbar.setVisibility(View.INVISIBLE);
                                Toast.makeText(AddPostShoes.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                            }
                    ...
                    post_progressbar.setVisibility(View.INVISIBLE);
                    Toast.makeText(AddPostShoes.this, "Please check the fields required!", Toast.LENGTH_SHORT).show();
                }
