...
public class DALogoutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_switch = view.findViewById(R.id.main_switch);
        btn_switch1 = view.findViewById(R.id.main_switch3);
...
//toolbar navigation
        ...
        ac.getSupportActionBar().setTitle("Seller Account Settings");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Glide.with(DALogoutFragment.this).load(imageUri).into(circleImageView);
                    }
                }
            }
        });
