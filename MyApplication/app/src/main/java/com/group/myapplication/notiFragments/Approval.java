...
public class Approval extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.approval_swipelayout);
        ...
        recyclerView = view.findViewById(R.id.approval_recview);
        ...
        if (firebaseAuth.getCurrentUser() != null) {
            ...
            CollectionReference subCollectionRef = firestore.collection("Users").document(currentuserID).collection("Approval");
    ...
    public void retrieve() {
        firestore.collection("Users").document(currentuserID).collection("Approval")
