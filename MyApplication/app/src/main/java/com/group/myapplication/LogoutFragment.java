...
public class LogoutFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_switch = view.findViewById(R.id.sellerview_switch);
...
//toolbar navigation
        signout = view.findViewById(R.id.signout_toolbar);
        ac.setSupportActionBar(signout);
        ac.getSupportActionBar().setTitle("Account Settings");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    if (task.getResult().exists()){
                        ...
                        Glide.with(LogoutFragment.this).load(imageUri).into(circleImageView);
                    }
                }
            }
        });
        ...
        btn_switch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getContext(), DADashbaord.class));
            }
        });
