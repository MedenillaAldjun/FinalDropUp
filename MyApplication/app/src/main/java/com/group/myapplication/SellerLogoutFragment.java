...
public class SellerLogoutFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_seller_logout2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_switch = view.findViewById(R.id.switchtoda);
...
//toolbar navigation
        signout = view.findViewById(R.id.signout_sellerDashboard_toolbar);
        ac.setSupportActionBar(signout);
        ac.getSupportActionBar().setTitle("DA Account Settings");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    if (task.getResult().exists()) {
                        ...
                        Glide.with(SellerLogoutFragment.this).load(imageUri).into(circleImageView);
                    }
                }
            }
        });
