...
public class Dropped extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.dropped_swipelayout);
        ...
        recyclerView = view.findViewById(R.id.buyernotif_recview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        currentuserID = firebaseAuth.getUid();

        mList = new ArrayList<>();
        adapter = new BuyerNotificationsAdapter(getActivity(), mList);
        ...
        if(firebaseAuth.getCurrentUser() != null){
            ...
            CollectionReference subCollectionRef = firestore.collection("Users").document(currentuserID).collection("BuyerNotif");
    ...
    public void retrieve() {
        firestore.collection("Users").document(currentuserID).collection("BuyerNotif")
