...
public class CashoutAdapter extends RecyclerView.Adapter<CashoutAdapter.RequestViewHolder> {
    ...
    public CashoutAdapter(Activity context,  List<Cashout> mList){
        this.mList = mList;
    ...
    @NonNull
    @Override
    public CashoutAdapter.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.each_cashout, parent, false);
        firestore = FirebaseFirestore.getInstance();
        return new CashoutAdapter.RequestViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CashoutAdapter.RequestViewHolder holder, int position1) {
        Cashout notif = mList.get(position1);
        holder.setItemsPic(notif.getImage1());
        holder.setPostCaption(notif.getCaption1());

        long milli1 = notif.getTime1().getTime();
        String date = DateFormat.format("MM/dd/yyy", new Date(milli1)).toString();
        holder.setPostDate(date);

        String userId = notif.getUser1();
...
// Get the "comments" subcollection of the post
        CollectionReference commentsRef = postRef.collection("CashoutNotif");
                ...
                alert.setTitle("Delete Notification?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                showPD();
                                CollectionReference commentsRef = firestore.collection("Users").document(userId).collection("CashoutNotif");
    ...
    public class RequestViewHolder extends RecyclerView.ViewHolder{
        ...
        public RequestViewHolder(@NonNull View itemView) {
            ...
            delete = view.findViewById(R.id.cashout_del);
