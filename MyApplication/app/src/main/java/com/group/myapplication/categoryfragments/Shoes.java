...
import com.group.myapplication.Adapter.ShoesAdapter;
...
public class Shoes extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.shoes_swipelayout);
        ...
        recyclerView = view.findViewById(R.id.shoes_recview);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        mList = new ArrayList<>();
        adapter = new ShoesAdapter(getContext(), mList);
        ...
        if(firebaseAuth.getCurrentUser() != null){
            ...
            query = firestore.collection("Shoes").orderBy("time", Query.Direction.DESCENDING);
