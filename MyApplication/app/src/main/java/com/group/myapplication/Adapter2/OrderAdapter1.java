...
public class OrderAdapter1 extends RecyclerView.Adapter<OrderAdapter1.RequestViewHolder> {
    ...
    public OrderAdapter1(Activity context,  List<Order1> mList){
        this.mList = mList;
    ...
    @NonNull
    @Override
    public OrderAdapter1.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.each_order1, parent, false);
        firestore = FirebaseFirestore.getInstance();
        return new OrderAdapter1.RequestViewHolder(view);


    }

    @Override
    public void onBindViewHolder(@NonNull OrderAdapter1.RequestViewHolder holder, int position1) {
        Order1 notif = mList.get(position1);
        holder.setPostCaption("Seller Comment: "+ notif.getCaption2());

        holder.setRating("Buyer Rating: " + notif.getRating());
...
// Get the "comments" subcollection of the post
        CollectionReference commentsRef = postRef.collection("BuyerFeedback1");
                ...
                alert.setTitle("Delete Notification?")
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                showPD();
                                CollectionReference commentsRef = firestore.collection("Users").document(userId).collection("BuyerFeedback1");
    ...
    public class RequestViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView postUsername,postDate,postCaption, rating;
        View view;
        ImageButton delete;
        ...
        public RequestViewHolder(@NonNull View itemView) {
            super(itemView);
            view = itemView;
            delete = view.findViewById(R.id.feedbacks_del);
        ...
        public void setPostCaption (String cap){
            postCaption = view.findViewById(R.id.capt);
            postCaption.setText(cap);
        }
        public void setRating (String cap){
            rating = view.findViewById(R.id.buyer_rating);
            rating.setText(cap);
        }
